        ...
        return (
            <html lang='en'>
                <head>
                    ...
                    <meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'></meta>
                    {
                        (() => {
                            if (this.props.pageInfo.description) {
                                return <meta name='description' content={this.props.pageInfo.description}></meta>
                            }
                        })()
                    }
                    <link rel='mask-icon' href='public/images/Nalie.svg' color='red'/>
                    <link rel='icon' sizes='any' mask href='/public/images/Nalie.svg'/>
                    <link rel='icon' type='image/x-icon' href='/public/Nalie.ico'/>
                    ...
                    <meta name='viewport' content='user-scalable=no, initial-scale=1, maximum-scale=1, minimum-scale=1, width=device-width, height=device-height, target-densitydpi=device-dpi'></meta>
