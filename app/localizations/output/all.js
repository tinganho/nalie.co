;(function() {
  ...
  var localizations = {
    'en-US': {
      ...
      'FOOTER->ABOUT': function(it) {
        var string = '';
        string += 'About';
        return string;
      },
      'FOOTER->CONTACT': function(it) {
        var string = '';
        string += 'Contact';
        return string;
      },
      'FOOTER->JOBS': function(it) {
        var string = '';
        string += 'Jobs';
        return string;
      },
      'FOOTER->TERMS': function(it) {
        var string = '';
        string += 'Terms';
        return string;
      },
      'JOIN_FORCES_WITH_US->ROLE1': function(it) {
        var string = '';
        string += 'HW Design Engineer';
        return string;
      },
      'JOIN_FORCES_WITH_US->ROLE2': function(it) {
        var string = '';
        string += 'Industrial Designer';
        return string;
      },
      'JOIN_FORCES_WITH_US->ROLE3': function(it) {
        var string = '';
        string += 'Software Engineer';
        return string;
      },
      'JOIN_FORCES_WITH_US->ROLE4': function(it) {
        var string = '';
        string += 'Frontend Engineer';
        return string;
      },
      'JOIN_FORCES_WITH_US->SUB_TITLE': function(it) {
        var string = '';
        string += 'It requires a team to build something evolutionary. Join forces with us to tackle some of the hardest problems.';
        return string;
      },
      'JOIN_FORCES_WITH_US->TITLE': function(it) {
        var string = '';
        string += 'Join Forces With Us';
        return string;
      },
      'THE_WORLD_WILL_CHANGE->SUB_TITLE': function(it) {
        var string = '';
        string += 'If Nalie succeeds, it will change the lives of millions.';
        return string;
      },
      'THE_WORLD_WILL_CHANGE->TITLE': function(it) {
        var string = '';
        string += 'The World Will Change';
        return string;
      },
      'THE_NEXT_EVOLUTION->SUB_TITLE': function(it) {
        var string = '';
        string += 'The Web have taken 4 major evolution steps and we think Nalie will help make its fifth’s with the help of a device.';
        return string;
      },
      'THE_NEXT_EVOLUTION->TITLE': function(it) {
        var string = '';
        string += 'The Next Evolution';
        return string;
      },
      'HERO->SUB_TITLE': function(it) {
        var string = '';
        string += 'Representing the next evolution of the web.';
        return string;
      }
    }
  };
